...
$(function () {
    ...
    var retreatList_global = ['name', 'idCard', 'fullName', 'disabled', 'retreatApplicationDescription'];
    ...
    function refreshDG() {
        ...
        $('#league_menber').datagrid({
            ...
            loader: function (param, success, error) {
                ...
                // 满28岁已离团列表
                LeagueMemberApi.leftAt28YearsOldList({
            ...
            toolbar: [{
                ...
                handler: function(){
                    ...
                    // 团籍状态 -- 0:正常,1:禁用.2:满28周岁离团,3:满28周岁离团待审核,4:自行脱团,5:自行脱团待审核,6:自愿退团,7:自愿退团待审核,8:开除团籍,9:开除团籍待审核
                    if(selectedData.disabled != 2) { // 满28周岁离团
                    ...
                    var html = '';
                    // 基本信息
                    // ['name', 'idCard', 'fullName', 'disabled', 'retreatApplicationDescription']
