...
var League = new Object({
    ...
    domain: window.location.host, // 域名(192.168.20.44:8085)
    appid: undefined, // 应用ID(微信)
    path: undefined, //智慧团建接口地址
    url_qnzs: undefined, // 青年之声域名地址
    api_qnzs: undefined, // 青年之声接口地址
...
if(League.domain) {
    ...
    if(host == 'localhost' || (host.split('.').length == 4 && host.split('.')[0] == '192')) { // 开发环境(localhost:63342 或者 192.168.20.44:8091)
        ...
        League.api_qnzs = 'http://192.168.20.44:8089/qnzs';
        League.appid = 'wxfd72d1942e34cf11';
        League.url_qnzs = 'http://192.168.20.44';
    }else if(host.indexOf('1678r246x6.imwork.net') != -1) { // 杨敏阶花生壳
        League.path = League.env.dev_ymj_peanut;
        League.api_qnzs = 'http://qnzsapitest.2030y.com';
        League.appid = 'wxfd72d1942e34cf11';
    }else if(host.indexOf('tuan2.12355.net') != -1) { // 外网环境(游美英)
        League.path = League.env.dev_ymy;
        League.api_qnzs = 'https://qnzsapi2.12355.net';
        League.appid = 'wxfd72d1942e34cf11';
        League.url_qnzs = 'https://qnzs2.12355.net';
    }else { // 生产环境
        League.path = League.env.publish;
        League.api_qnzs = 'https://api.12355.net';
        League.appid = 'wx2cccc41315c0ac7a';
        League.url_qnzs = 'https://www.12355.net';
    }
}
 ...
 * @returns {*}
 */
League.MyProfile = function (params) {
