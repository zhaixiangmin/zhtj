...
$(function () {
    ...
    function renderList(isClear) {
        // 团员列表
        RelationApi.draftsmanshipList(params).then(function (data) {
            ...
            for(var i=0; i<list.length; i++) {
                ...
                // html += '<a style="display: inline-block;" class="table_con table_tr clearfix" href="member_detail.html?mid=' + item.mid + '">';
