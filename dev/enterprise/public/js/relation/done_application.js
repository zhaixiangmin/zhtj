...
$(function () {
    ...
    function renderList(isClear) {
        // 已办列表
        RelationApi.haveTodoList(params).then(function (data) {
            console.log('RelationApi.haveTodoList data', data);
            var list = data.rows;
            var html = '';
            ...
            for(var i=0; i<list.length; i++) {
                ...
                html += '    <div class="td">' + Utils.validOrgName(item.primalName) + '</div>';
